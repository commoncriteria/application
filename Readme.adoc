...
* https://commoncriteria.github.io/application/master/application-release.pdf[Protection
Profile for Application Software] (pdf)

=== Release Version

* https://www.niap-ccevs.org/protectionprofiles/516[Protection
Profile for Application Software v2.0]
